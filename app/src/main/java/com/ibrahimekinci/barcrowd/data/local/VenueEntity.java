...
public class VenueEntity {
    ...
    public Date getCrowdLevelUpdatedAt() { return crowdLevelUpdatedAt; }
    ...
    public void setCrowdLevelUpdatedAt(Date crowdLevelUpdatedAt) { this.crowdLevelUpdatedAt = crowdLevelUpdatedAt; }
