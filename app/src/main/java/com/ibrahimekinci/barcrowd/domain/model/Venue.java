...
public class Venue implements Parcelable {
    ...
    @NonNull public String getLogoUrl() { return logoUrl; }
    @NonNull public String getAddress() { return address; }
    public double getLatitude() { return latitude; }
    public double getLongitude() { return longitude; }
    @NonNull public Map<String, String> getOpeningHours() { return openingHours; }
    public String getAverageCrowdLevel() { return averageCrowdLevel; }
    public String getLastCrowdLevel() { return lastCrowdLevel; }
    public String getAverageWaitTime() { return averageWaitTime; }
    public String getLastWaitTime() { return lastWaitTime; }
    public Timestamp getCrowdLevelUpdatedAt() { return crowdLevelUpdatedAt; }
    public String getMostPopulousAge() { return mostPopulousAge; }
    ...
    public void setAverageCrowdLevel(String averageCrowdLevel) { this.averageCrowdLevel = averageCrowdLevel; }
    public void setLastCrowdLevel(String lastCrowdLevel) { this.lastCrowdLevel = lastCrowdLevel; }
    public void setAverageWaitTime(String averageWaitTime) { this.averageWaitTime = averageWaitTime; }
    public void setLastWaitTime(String lastWaitTime) { this.lastWaitTime = lastWaitTime; }
    public void setCrowdLevelUpdatedAt(Timestamp crowdLevelUpdatedAt) { this.crowdLevelUpdatedAt = crowdLevelUpdatedAt; }
    public void setMostPopulousAge(String mostPopulousAge) { this.mostPopulousAge = mostPopulousAge; }
