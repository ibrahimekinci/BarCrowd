...
public class LiveUpdate implements Parcelable {
    ...
    @NonNull public String getVenueId() { return venueId; }
    @NonNull public String getUserId() { return userId; }
    @NonNull public String getCrowdLevel() { return crowdLevel; }
    @NonNull public String getWaitTime() { return waitTime; }
    @NonNull public String getAgeRange() { return ageRange; }
    @NonNull public String getMediaUrl() { return mediaUrl; }
    ...
    public void setCrowdLevel(@NonNull String crowdLevel) { this.crowdLevel = crowdLevel; }
    public void setWaitTime(@NonNull String waitTime) { this.waitTime = waitTime; }
    public void setAgeRange(@NonNull String ageRange) { this.ageRange = ageRange; }
    public void setMediaUrl(@NonNull String mediaUrl) { this.mediaUrl = mediaUrl; }
